...
if($res = $con->query($sql)){ 
	...
	echo "<font size='18' face='Calligrapher'>";
		echo "<table border='2' cellspacing='3' align='center'>"; 
			echo "<tr>"; 
				echo "<th colspan='3' bgcolor='black'>id </th>"; 
				echo "<th colspan='3' bgcolor='black'>pdf_file</th>"; 				
			echo "</tr>"; 
			
		while($row = $res->fetch_array()){ 
			echo "<tr>"; 
				echo "<td colspan='3' bgcolor='black'>" . $row['id'] . "</td>";
				echo "<td colspan='3' bgcolor='black'>" . $row['pdf_file'] . "</td>";
			echo "</tr>"; 
		} 
		echo "</table>"; 
		echo "</div>";
