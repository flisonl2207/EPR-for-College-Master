...
if($res = $con->query($sql)){ 
	...
	echo "<font size='18' face='Calligrapher'>";
		echo "<table border='2' cellspacing='3' align='center'>"; 
			echo "<tr>"; 
				echo "<th colspan='3' bgcolor='black'>Eve_name </th>"; 
				echo "<th colspan='3' bgcolor='black'>Eve_des</th>"; 
				echo "<th colspan='3' bgcolor='black'>Eve_date</th>"; 
				echo "<th colspan='3' bgcolor='black'>Eve_id</th>";  				
			echo "</tr>"; 
			
		while($row = $res->fetch_array()){ 
			echo "<tr>"; 
				echo "<td colspan='3' bgcolor='black'>" . $row['Eve_name'] . "</td>";
				echo "<td colspan='3' bgcolor='black'>" . $row['Eve_des'] . "</td>"; 
				echo "<td colspan='3' bgcolor='black'>" . $row['Eve_date'] . "</td>";
				echo "<td colspan='3' bgcolor='black'>" . $row['Eve_id'] . "</td>";
			echo "</tr>"; 
		} 
		echo "</table>"; 
		echo "</div>";
