...
<nav class="navbar navbar-custom">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li><a href="http://localhost/tutorials/authentication/login.html"> TEACHERs portal</a></li>
	...
	echo "<font size='18' face='Calligrapher'>";
		echo "<table border='2' cellspacing='3' align='center'>"; 
			echo "<tr>"; 
				...
				echo "<th colspan='3' bgcolor='black'>Branch</th>"; 
				echo "<th colspan='3' bgcolor='black'>Department</th>"; 
				echo "<th colspan='3' bgcolor='black'>PhoneNo</th>";
			echo "</tr>"; 
		...
		while($row = $res->fetch_array()){ 
			echo "<tr>"; 
				...
				echo "<td colspan='3' bgcolor='black'>" . $row['Branch'] . "</td>";
				echo "<td colspan='3' bgcolor='black'>" . $row['Department'] . "</td>";
				echo "<td colspan='3' bgcolor='black'>" . $row['PhoneNo'] . "</td>";
			echo "</tr>"; 
		} 
		echo "</table>"; 
		$res->free(); 
