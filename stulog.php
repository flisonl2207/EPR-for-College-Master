...
$sql = "SELECT Rollno FROM users WHERE username='$username' AND password='$password'"; 
...
if($res = $con->query($sql)){ 
   ...
   echo "login_success";		
	...
	$messagee = "Login_Denied";
    echo "<script type='text/javascript'>alert('$messagee');</script> " . mysqli_error($link);
}}
...
<form method="POST" action="stulog.php">
  <table>
  <tr>
    <td>Username: </td>
